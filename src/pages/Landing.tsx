  ...
  return (
    <>
      ...
      <div style={{ background: C.bg, color: C.text, fontFamily: "'DM Sans', sans-serif" }}>
        ...
        {/* ─── Header ─── */}
        <header style={{ borderBottom: `1px solid ${C.border}`, background: `${C.bg}dd`, backdropFilter: "blur(14px)" }} className="sticky top-0 z-50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
              {[
                ...
                <div key={s.label} style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 20, padding: "28px 12px" }}>
                  <div style={{ fontFamily: BEBAS, fontSize: "clamp(3rem, 5vw, 4.2rem)", lineHeight: 1, color: C.text }}>
            ...
            <div className="flex flex-col md:flex-row items-stretch gap-3 mb-14">
              {[
                ...
                <div key={step.n} className="flex flex-col md:flex-row items-center gap-3 flex-1">
                  ...
                  {i < 2 && (
                    <div style={{ color: C.muted, fontSize: "1.5rem", flexShrink: 0, transform: "rotate(90deg)" }} className="md:rotate-0" aria-hidden>
                      →
                    </div>
                  )}
                </div>
